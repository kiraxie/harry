# Debt ledger — shared procedure

The shared, drift-prone `/debt` procedure used by **both** builds:
`commands/debt.md` (Claude Code) and `codex-skills/debt/SKILL.md` (Codex CLI).
