...
| Standard | 2–5 files, real logic, single subsystem | compressed | on-decision | bullet | one runnable check | free subagent (required) | session |
