...
#           "screen_dir":"/path/to/project/.local/brainstorm/12345-1706000000/content",
#           "state_dir":"/path/to/project/.local/brainstorm/12345-1706000000/state"}
```
...
If the session used `--project-dir`, mockup files persist in `.local/brainstorm/` for later reference. Only `/tmp` sessions get deleted on stop.
