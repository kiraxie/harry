---
description: Retrieve the output of a completed background review job. Defaults to the latest finished job; pass a job-id to fetch a specific one.
...
- Successful job → branch name, files modified, lines added/removed, and the `summary`.
