...
- Failure signals: a non-zero exit, a `# Ask Failed` first line of stdout, or a `Fatal error: <message>` line on stderr. If you see any of these, report the failure and stop — never present that body as the model's answer.
