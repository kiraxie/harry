---
description: Show harry's Codex rate-limit snapshot — quota usage and reset windows, as of the last ask run.
...
The quota shown is a cached snapshot — refreshed after every `ask` run (`review` does not refresh it) — with its age labelled in the header.
